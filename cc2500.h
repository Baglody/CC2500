...
#define CC_CS_IO_PIN GPIO_Pin_6
#elif QXW_LCM_ID == 212
#define CC_GDO0_IO_GROUP GPIOD
#define CC_GDO0_IO_PIN GPIO_Pin_6
#define CC_CS_IO_GROUP GPIOD
#define CC_CS_IO_PIN GPIO_Pin_3
#endif

//GDO0
#define GDO0_IN()				GPIO_ReadInputDataBit(CC_GDO0_IO_GROUP,CC_GDO0_IO_PIN)

//MISO
#define MISO_IN()	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_14)

//CS
#define CC2500_Select()  {GPIO_ResetBits(CC_CS_IO_GROUP, CC_CS_IO_PIN);while(MISO_IN());}//Ò²ÐíÐèÒªµÈ´ý SPI_MISO_IN()  
#define CC2500_NoSelect()  GPIO_SetBits(CC_CS_IO_GROUP, CC_CS_IO_PIN)
...
typedef enum{
	CRA_ALL=0,//½ÓÊÕËùÓÐµØÖ·µÄ°ü
	CRA_FIXED,//½ÓÊÕÖ¸¶¨µØÖ·µÄ°ü
	CRA_FIXED_00,//½ÓÊÕÖ¸¶¨µØÖ·ºÍ00¹ã²¥°ü
	CRA_FIXED_00_FF,//½ÓÊÕÖ¸¶¨µØÖ·ºÍ00¹ã²¥°üºÍff¹ã²¥°ü
}CC2500_RECV_ADDR;//Ä¬ÈÏ½ÓÊÕÊý¾ÝµÄµÚÒ»¸ö×Ö½Ú±íÊ¾µØÖ·
...
u8 CC2500_ReceivePacket(u8 *buf); 

void	CC2500_Reset(void);
void	CC2500_SpiWriteReg(u8  addr, u8 value);
